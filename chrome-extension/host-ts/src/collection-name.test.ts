...
describe('determineCollectionName', () => {
  ...
  describe('GitHub', () => {
    ...
    it('identifies GitHub gists', () => {
      // gist.github.com is matched before the regular github.com patterns
  ...
  describe('Social Media', () => {
    ...
    it('identifies Instagram posts', () => {
      expect(determineCollectionName('https://www.instagram.com/p/ABC123/')).toBe('instagram_posts');
    });

    it('identifies Instagram profiles', () => {
      expect(determineCollectionName('https://www.instagram.com/username')).toBe('instagram_profiles');
    });

    it('identifies Facebook groups', () => {
      expect(determineCollectionName('https://www.facebook.com/groups/groupname')).toBe('facebook_groups');
    });
  });
  ...
  describe('Default/Fallback', () => {
    ...
    it('includes subdomain for non-www subdomains', () => {
      // blog. subdomain triggers blog pattern, returning _blog_posts
      expect(determineCollectionName('https://blog.mysite.com/post')).toBe('mysite_blog_posts');
      // Other subdomains return _subdomain_pages
